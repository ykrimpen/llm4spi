...
if __name__ == '__main__':
    model = GPT4All("orca-mini-3b-gguf2-q4_0.gguf", model_path="/root/models", device="gpu") #device is specific to cluster's GPU, change accordingly when run on a different computer
